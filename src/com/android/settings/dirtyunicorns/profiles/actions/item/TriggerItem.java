...
public class TriggerItem extends BaseItem {
    ...
    public String getSummary() {
        ...
        if (sb.length() == 0) {
            if (mTriggerType == NFC) {
                return getString(R.string.sp_no_triggers_configured_nfc);
            } else {
                return getString(R.string.sp_no_triggers_configured);
            }
        }
    ...
    public static int getTitleString(int triggerType) {
        switch (triggerType) {
            case WIFI:
                return R.string.sp_profile_tabs_wifi;
            case BLUETOOTH:
                return R.string.sp_profile_tabs_bluetooth;
            case NFC:
                return R.string.sp_profile_tabs_nfc;
            default: return 0;
        }
    }
}