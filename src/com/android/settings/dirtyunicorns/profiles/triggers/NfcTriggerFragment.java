...
package com.android.settings.dirtyunicorns.profiles.triggers;
...
import com.android.settings.dirtyunicorns.profiles.NFCProfileTagCallback;
import com.android.settings.dirtyunicorns.profiles.NFCProfileUtils;
...
public class NfcTriggerFragment extends Fragment implements NFCProfileTagCallback {
    ...
    public static NfcTriggerFragment newInstance(Profile profile) {
        ...
        extras.putParcelable(ProfilesSettingsFragment.EXTRA_PROFILE, profile);
    ...
    public void onTagRead(Tag tag) {
        if (NFCProfileUtils.writeTag(NFCProfileUtils.getProfileAsNdef(mProfile), tag)) {
            Toast.makeText(getActivity(), R.string.sp_profile_write_success, Toast.LENGTH_LONG).show();
            NFCProfileUtils.vibrate(getActivity());
        } else {
            Toast.makeText(getActivity(), R.string.sp_profile_write_failed, Toast.LENGTH_LONG).show();
        }
    }
