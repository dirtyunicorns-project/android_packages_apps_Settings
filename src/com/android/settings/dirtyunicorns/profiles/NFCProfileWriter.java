...
public class NFCProfileWriter extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.sp_profile_write_nfc_tag);
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(intent.getAction())) {
            ...
            if (NFCProfileUtils.writeTag(NFCProfileUtils.getProfileAsNdef(mProfile), detectedTag)) {
                Toast.makeText(this, R.string.sp_profile_write_success, Toast.LENGTH_LONG).show();
                NFCProfileUtils.vibrate(this);
            } else {
                Toast.makeText(this, R.string.sp_profile_write_failed, Toast.LENGTH_LONG).show();
            }
            finish();
        }
    }
