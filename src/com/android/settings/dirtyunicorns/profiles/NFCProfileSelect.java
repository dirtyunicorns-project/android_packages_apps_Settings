...
public class NFCProfileSelect extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.sp_profile_unknown_nfc_tag);
    ...
    void showProfileSelectionDialog() {
        ...
        builder.setTitle(R.string.sp_profile_settings_title);
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (currentChoice != defaultChoice) {
                    ...
                    Toast.makeText(NFCProfileSelect.this, R.string.sp_profile_write_success, Toast.LENGTH_LONG).show();
                }
                finish();
            }
        });
