package com.android.settings.dirtyunicorns.profiles.utils;
...
import static com.android.settingslib.lineageos.preference.DeviceKeysConstants.*;

public class DeviceUtils {

    /* returns whether the device has volume rocker or not. */
    public static boolean hasVolumeRocker(Context context) {
        final int deviceKeys = context.getResources().getInteger(com.android.internal.R.integer.config_deviceHardwareKeys);
