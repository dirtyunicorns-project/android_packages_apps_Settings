...
import com.android.settings.dirtyunicorns.profiles.triggers.BluetoothTriggerFragment;
import com.android.settings.dirtyunicorns.profiles.triggers.NfcTriggerFragment;
import com.android.settings.dirtyunicorns.profiles.triggers.WifiTriggerFragment;
...
public class TriggerPagerAdapter extends FragmentPagerAdapter {
    ...
    public enum TriggerFragments {
         ...
         * The artist fragment
         */
        WIFI(WifiTriggerFragment.class, R.string.sp_profile_tabs_wifi),
        /**
         * The album fragment
         */
        BLUETOOTH(BluetoothTriggerFragment.class, R.string.sp_profile_tabs_bluetooth),
        /**
         * The song fragment
         */
        NFC(NfcTriggerFragment.class, R.string.sp_profile_tabs_nfc);
